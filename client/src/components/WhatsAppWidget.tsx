...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      ...
      {isOpen && (
        <div className="bg-white rounded-lg shadow-xl mb-4 w-72 overflow-hidden animate-fade-in">
          <div className="bg-green-500 p-4 flex items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-xs">We're online</p>
            </div>
            <button 
          ...
          <div className="p-4 bg-gray-50">
            <p className="text-sm text-gray-700 mb-4">Hello! How can we help you today?</p>
            <button 
              onClick={handleWhatsAppClick}
              className="w-full bg-green-500 text-white py-2 px-4 rounded-md font-medium hover:bg-green-600 transition-colors flex items-center justify-center"
            >
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                viewBox="0 0 448 512" 
          ...
          <div className="p-3 bg-white text-center">
            <span className="text-xs text-gray-500">Powered by <span className="font-semibold">WAVETXT</span></span>
          </div>
        </div>
      )}
